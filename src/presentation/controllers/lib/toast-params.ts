...
export const toastCreateParams: toastParams = {
  success: {
...
export const toastReadParams: toastParams = {
  success: {
...
export const toastUpdateParams: toastParams = {
  success: {
...
export const toastDeleteParams: toastParams = {
  success: {
